...
describe('FillStyle', () => {
    ...
    it('json', () => {
        const style = new FillStyle('#00ff00', 'red', 4);
        expect(JSON.stringify(style.json())).toEqual(`{"type":"fill-style","name":"Fill Style","maximumScale":null,"minimumScale":0,"lineWidth":4,"fillStyle":"#00ff00","strokeStyle":"red"}`);
    });
