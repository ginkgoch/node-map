...
describe('StyleFactory', () => {
    ...
    it('deserialize fill style', () => {
        const json = JSON.parse(`{"type":"fill-style","name":"Fill Style","visible":true,"maximumScale":10000000000,"minimumScale":0,"lineWidth":4,"fillStyle":"#00ff00","strokeStyle":"red"}`);
